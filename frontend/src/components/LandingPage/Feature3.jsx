...
const Feature3 = () => {
    return (
        <section className="m-4 md:m-8 p-[100px] text-black">
            <div className="container mx-auto p-4 my-6 space-y-2 text-center">
                <h2 className="text-5xl font-bold">Built to help every cause</h2>
                <p className="dark:text-gray-400">If you feel bad about life, here we are to create a Better World</p>
            </div>
