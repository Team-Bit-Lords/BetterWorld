    ...
    <aside className="fixed w-72 inset-0 my-4 ml-4 h-[calc(100vh - 32px)] rounded-xl bg-neutral">
      <div className="border-b border-white/20">
        <a className="flex items-center py-6 px-8 gap-4">
          {/* <img
            ...
            src={logoImg}
          /> */}
          <h6 className="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-base-100">
      ...
      <div className="m-4">
        <ul className="mb-4 flex flex-col gap-1">
          <li>
            <a aria-current="page" href="#/dashboard/home">
              <button
          ...
          <li>
            <a className="" href="#/dashboard/leaderboard">
              <button
        ...
        <ul className="mb-4 flex flex-col gap-1">
          <li className="mx-3.5 mt-4 mb-2">
            <p className="block antialiased font-sans text-xs leading-normal text-white font-bold uppercase opacity-75">
              auth pages
            </p>
          </li>
          <li>
            <a className="" href="#/auth/sign-in">
              <button
                className="font-bold transition-all text-xs py-3 rounded-lg text-base-100 hover:bg-white/10 active:bg-white/30 w-full flex items-center gap-4 px-4 capitalize"
                type="button"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
